    ...
    <div class="content">
    	 ...
    	 <div id="tab-contents">
    	 	<div id="tab-manage-widgets">
    	 		...
    	 		<div>
    	 			<a class="button btn-action-widget" href="index.php?route=module/megamenubase/addwidget&token=<?php echo $token; ?>" ><?php echo $this->language->get('text_create_widget'); ?></a>
    	 		</div>
    	 		 <table class="form">
    	 		 	<tr>	
    	 		 	...
    	 		 	<tr>
	    	 		 	...
	    	 		 	<td><a class="btn-action-widget" rel="edit" href="index.php?route=module/megamenubase/addwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $this->language->get('text_edit'); ?></a>
	    	 		 		| 
	    	 		 		<a onclick="return confirm('<?php echo $this->language->get('text_confirm_delete');?>');"  rel="edit" href="index.php?route=module/megamenubase/delwidget&token=<?php echo $token; ?>&id=<?php echo $widget['id'];?>&wtype=<?php echo $widget['type'];?>"><?php echo $this->language->get('text_delete'); ?></a>
	    	 		 	</td>
    	 		 	<?php } ?>
    	 		 	</tr>
    	 		 	<?php } ?>
			...
			<div id="tabss" class="htabs">
				<a class="selected" href="#megamenu-form">Manage megamenu</a>
				<a  href="#tree-megamenu">Config Layout</a>
			</div>
			<div id="tab-contents">
				<div id="tree-megamenu">
