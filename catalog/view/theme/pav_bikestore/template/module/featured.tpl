...
<div class="box box-produce special">
 <!-- <div class="box-heading"><h3><span><?php echo $heading_title; ?></span></h3></div> -->
    <div class="title-feature" >
         <h3>Today’s Website Templates</h3>
          <p>Since 2002 we have developed over 40,000 templates. See the recently added below:</p>
    </div>
    ...
    <div class="box-product" >
			  ...
			  <div class="product-block span<?php echo $span;?>"><div class="product-inner">
		    	...
		    	<?php }
		    	 ...
		    	 ?>
                    <div class="product-label-special label home-new ">&nbsp;</div>
                   <?php  } ?>
		        ...
		        <div class="product-link">
                    <a class="link-live-demo" href="<?php echo $product['href_demo'];  ?>">Live demo</a>
                    <a class="link-view-details" href="<?php echo $product['href']; ?>">View details</a>
		        </div>
			</div>
