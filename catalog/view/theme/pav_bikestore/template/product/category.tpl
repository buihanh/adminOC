...
<div class="product-list"> <div class="row-fluid">
	...
	<?php if( $i++%$cols == 0 ) { ?>
		  <div class="row-fluid">
	<?php } ?>
    <div class="span<?php echo $span;?> product-block product-category">
    	
      <?php if ($product['thumb']) { ?>
      <div class="image"><?php if( $product['special'] ) {   ?>
    	<span class="product-label-special sale-category label">&nbsp;</span>
    	<?php } ?>
	 ...
	 <div class="group-item"> 
	  <div class="price-cart">
		...
		<div class="product-link">
			<a class="link-live-demo" href="<?php echo $this->url->link('product/demo', 'product_id=' . $product['product_id']); ?>">Live demo</a>
