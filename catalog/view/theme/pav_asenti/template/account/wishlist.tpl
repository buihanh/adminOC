				...
				<tbody id="wishlist-row<?php echo $product['product_id']; ?>">
					<tr>
						...
						<td class="action">
							...
							<div class="avg-right">
								<img src="catalog/view/theme/pav_asenti/image/cart-add.png" alt="<?php echo $button_cart; ?>" title="<?php echo $button_cart; ?>" onclick="addToCart('<?php echo $product['product_id']; ?>');" />
								&nbsp;&nbsp;
