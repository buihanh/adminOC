				...
				<div class="content">
					<div class="row-fluid">
						...
						<div class="span6">
							...
							<input type="text" name="order_id" value="<?php echo $order_id; ?>" class="large-field span12" />
							<br />
							...
							<input type="text" name="date_ordered" value="<?php echo $date_ordered; ?>" class="large-field date span12" />
							<br />
						</div>
					</div>				  
				</div>
						...
						<div class="row-fluid">
							<div class="span4">
								<div class="return-name">
									...
									<input type="text" name="product" value="<?php echo $product; ?>" class="span12" />
									<br />
							...
							<div class="span4">
								<div class="return-model">
									...
									<input type="text" name="model" value="<?php echo $model; ?>" class="span12" />
									<br />
									<?php if ($error_model) { ?>
							...
							<div class="span4">
								<div class="return-quantity">
									...
									<input type="text" name="quantity" value="<?php echo $quantity; ?>" class="span12" />
								</div>
							</div>
						</div>					  
					</div>
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="return-opened">
									...
									<textarea name="comment" cols="150" rows="6" class="span12"><?php echo $comment; ?></textarea>
								</div>
							</div>
							<div class="span4">
