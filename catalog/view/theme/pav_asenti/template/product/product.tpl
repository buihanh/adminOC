	...
	$(document).ready(function() {
			...
			$.ajax({
				...
				success: function(json) {
					...
					if (json['success']) {
						...
						$('#notification').html('<div class="success" style="display: none;">' + json['success'] + '<img src="catalog/view/theme/pav_asenti/image/close.png" alt="" class="close" /></div>');
		...
		new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
			...
			onSubmit: function(file, extension) {
				$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/pav_asenti/image/loading.gif" class="loading" style="padding-left: 5px;" />');
	...
	$('#button-review').bind('click', function() {
		$.ajax({
			...
			beforeSend: function() {
				...
				$('#review-title').after('<div class="attention"><img src="catalog/view/theme/pav_asenti/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
			},
			complete: function() {
