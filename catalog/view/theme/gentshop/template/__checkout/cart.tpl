...
<section class="col-lg-<?php echo $SPAN[1];?> col-md-<?php echo $SPAN[1];?> col-sm-12 col-xs-12">
	...
	<div id="content">
		...
		<div class="checkout wrapper no-margin">		
			...
			<div class="cart-module">
				...
				<div id="shipping" class="content" style="display: <?php echo ($next == 'shipping' ? 'block' : 'none'); ?>;">
					...
					<input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button btn btn-theme-default margin" />
				</div>
			</div>
		<?php } ?>
		...
		<div class="buttons">
			<div class="right"><a href="<?php echo $checkout; ?>" class="button btn btn-theme-default"><?php echo $button_checkout; ?></a></div>
