				...
				<div clas="wrapper no-margin">
					<p><?php echo $text_description; ?></p>
					  <p><?php echo $text_code; ?><br />
					    <textarea class="control-label" cols="40" rows="5"><?php echo $code; ?></textarea>
					  </p>
					  <p><?php echo $text_generator; ?><br />
					    <input class="control-label" type="text" name="product" value="" />
					  </p>
					  <p><?php echo $text_link; ?><br />
					    <textarea class="control-label" name="link" cols="40" rows="5"></textarea>
					  </p>
					  <div class="buttons">
