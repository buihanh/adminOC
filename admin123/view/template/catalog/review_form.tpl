    ...
    <div class="content">
      ...
      <form  class="form-horizontal" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label" for="username"><span class="required">*</span>Người tạo:</label>
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label" for="username"><span class="required">*</span>Sản phẩm:</label>
              <div class="col-sm-6 col-lg-4 controls">
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label" for="username">Nội dung</label>
              <div class="col-sm-6 col-lg-4 controls">
                  <textarea class="form-control" name="text" cols="60" rows="8"><?php echo $text; ?></textarea>
                  <?php if ($error_text) { ?>
          ...
          <div class="form-group">
              <label class="col-sm-3 col-lg-2 control-label" for="username">Đánh giá:</label>
              <div class="col-sm-6 col-lg-4 controls">
