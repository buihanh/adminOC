		...
		<div class="table-responsive">
			<table class="table table-advance">
				...
				<tbody>
					 <tr class="filter">
					  <td></td>
					  <td align="right"><input type="text" class="form-control" name="filter_return_id" value="<?php echo $filter_return_id; ?>" size="4" style="text-align: right;" /></td>
					  ...
					  <td><select class="form-control" name="filter_return_status_id">
						  <option value="*"></option>
