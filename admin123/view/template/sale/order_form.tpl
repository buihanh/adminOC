...
<div id="content">
  ...
  <?php } ?>
  <div class="box">
	<div class="buttons"><a class="btn btn-primary" onclick="$('#form').submit();" class="btn btn-primary"><?php echo $button_save; ?></a><a  class="btn btn-primary" href="<?php echo $cancel; ?>" class="btn btn-primary"><?php echo $button_cancel; ?></a></div>
	<br/><br/>
 
    <div class="content tble">
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-customer" class="vtabs-content">
          <table cellpadding="10" width="100%" class="form">
            <tr>
              ...
              <td class="left"><select class="form-control" name="store_id">
            ...
            <tr>
              ...
              <td><input  class="form-control"type="text" name="customer" value="<?php echo $customer; ?>" />
                <input  class="form-control"type="hidden" name="customer_id" value="<?php echo $customer_id; ?>" />
                <input  class="form-control"type="hidden" name="customer_group_id" value="<?php echo $customer_group_id; ?>" /></td>
            </tr>
            <tr>
              <td class="left"><?php echo $entry_customer_group; ?></td>
              <td class="left"><select class="form-control" id="customer_group_id" <?php echo ($customer_id ? 'disabled="disabled"' : ''); ?>>
		...
		<div id="tab-product" class="vtabs-content">
          <table cellpadding="10" width="100%" class="list">
            <thead>
              <tr>
                <td></td>
            ...
            <tbody id="product">
              ...
              <tr id="product-row<?php echo $product_row; ?>">
                ...
                <td class="left"><?php echo $order_product['name']; ?><br />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_product_id]" value="<?php echo $order_product['order_product_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][product_id]" value="<?php echo $order_product['product_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][name]" value="<?php echo $order_product['name']; ?>" />
                  <?php foreach ($order_product['option'] as $option) { ?>
                  - <small><?php echo $option['name']; ?>: <?php echo $option['value']; ?></small><br />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][order_option_id]" value="<?php echo $option['order_option_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][product_option_id]" value="<?php echo $option['product_option_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][product_option_value_id]" value="<?php echo $option['product_option_value_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][name]" value="<?php echo $option['name']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][value]" value="<?php echo $option['value']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_option][<?php echo $option_row; ?>][type]" value="<?php echo $option['type']; ?>" />
                  <?php $option_row++; ?>
                  <?php } ?>
                  <?php foreach ($order_product['download'] as $download) { ?>
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][order_download_id]" value="<?php echo $download['order_download_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][name]" value="<?php echo $download['name']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][filename]" value="<?php echo $download['filename']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][mask]" value="<?php echo $download['mask']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][order_download][<?php echo $download_row; ?>][remaining]" value="<?php echo $download['remaining']; ?>" />
                  <?php $download_row++; ?>
                  <?php } ?></td>
                <td class="left"><?php echo $order_product['model']; ?>
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][model]" value="<?php echo $order_product['model']; ?>" /></td>
                <td class="right"><?php echo $order_product['quantity']; ?>
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][quantity]" value="<?php echo $order_product['quantity']; ?>" /></td>                 
                <td class="right"><?php echo $order_product['price']; ?>
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][price]" value="<?php echo $order_product['price']; ?>" /></td>
                <td class="right"><?php echo $order_product['total']; ?>
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][total]" value="<?php echo $order_product['total']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][tax]" value="<?php echo $order_product['tax']; ?>" />
                  <input  class="form-control"type="hidden" name="order_product[<?php echo $product_row; ?>][reward]" value="<?php echo $order_product['reward']; ?>" /></td>
              </tr>
              <?php $product_row++; ?>
              <?php } ?>
              <?php } else { ?>
          ...
          <table cellpadding="10" width="100%" class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><input  class="form-control"type="text" name="product" value="" />
                  <input  class="form-control"type="hidden" name="product_id" value="" /></td>
              </tr>
              <tr id="option"></tr>
              <tr>
                <td class="left"><?php echo $entry_quantity; ?></td>
                <td class="left"><input  class="form-control"type="text" name="quantity" value="1" /></td>
              </tr>             
            </tbody>
            <tfoot>
              <tr>
	   ...
	   <div id="tab-total" class="vtabs-content">
            ...
            <tbody id="total">
              ...
              <tr id="total-row<?php echo $total_row; ?>">
                <td class="right" colspan="4"><?php echo $order_total['title']; ?>:
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][order_total_id]" value="<?php echo $order_total['order_total_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][code]" value="<?php echo $order_total['code']; ?>" />
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][title]" value="<?php echo $order_total['title']; ?>" />
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][text]" value="<?php echo $order_total['text']; ?>" />
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][value]" value="<?php echo $order_total['value']; ?>" />
                  <input  class="form-control"type="hidden" name="order_total[<?php echo $total_row; ?>][sort_order]" value="<?php echo $order_total['sort_order']; ?>" /></td>
          ...
          <table cellpadding="10" width="100%" class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><select class="form-control" name="shipping">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php if ($shipping_code) { ?>
                    <option value="<?php echo $shipping_code; ?>" selected="selected"><?php echo $shipping_method; ?></option>
                    <?php } ?>
                  </select>
                  <input  class="form-control"type="hidden" name="shipping_method" value="<?php echo $shipping_method; ?>" />
                  <input  class="form-control"type="hidden" name="shipping_code" value="<?php echo $shipping_code; ?>" />
              ...
              <tr>
                ...
                <td class="left"><select class="form-control" name="payment">
                    <option value=""><?php echo $text_select; ?></option>
                    <?php if ($payment_code) { ?>
                    <option value="<?php echo $payment_code; ?>" selected="selected"><?php echo $payment_method; ?></option>
                    <?php } ?>
                  </select>
                  <input  class="form-control"type="hidden" name="payment_method" value="<?php echo $payment_method; ?>" />
                  <input  class="form-control"type="hidden" name="payment_code" value="<?php echo $payment_code; ?>" />
              ...
              <tr>
                ...
                <td class="left"><input  class="form-control"type="text" name="coupon" value="" /></td>
              </tr>
              <tr>
                <td class="left"><?php echo $entry_voucher; ?></td>
                <td class="left"><input  class="form-control"type="text" name="voucher" value="" /></td>
              </tr>
              <tr>
                <td class="left"><?php echo $entry_reward; ?></td>
                <td class="left"><input  class="form-control"type="text" name="reward" value="" /></td>
              </tr>
              <tr>
                <td class="left"><?php echo $entry_order_status; ?></td>
                <td class="left"><select class="form-control" name="order_status_id">
              ...
              <tr>
                ...
                <td class="left"><textarea  class="form-control" name="comment" cols="40" rows="5"><?php echo $comment; ?></textarea></td>
              </tr>
              <tr>
                <td class="left"><?php echo $entry_affiliate; ?></td>
                <td class="left"><input  class="form-control"type="text" name="affiliate" value="<?php echo $affiliate; ?>" />
                  <input  class="form-control"type="hidden" name="affiliate_id" value="<?php echo $affiliate_id; ?>" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
		 ...
		 <div id="tab-voucher" class="vtabs-content">
            ...
            <tbody id="voucher">
              ...
              <tr id="voucher-row<?php echo $voucher_row; ?>">
                ...
                <td class="left"><?php echo $order_voucher['description']; ?>
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][order_voucher_id]" value="<?php echo $order_voucher['order_voucher_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][voucher_id]" value="<?php echo $order_voucher['voucher_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][description]" value="<?php echo $order_voucher['description']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][code]" value="<?php echo $order_voucher['code']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][from_name]" value="<?php echo $order_voucher['from_name']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][from_email]" value="<?php echo $order_voucher['from_email']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][to_name]" value="<?php echo $order_voucher['to_name']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][to_email]" value="<?php echo $order_voucher['to_email']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][voucher_theme_id]" value="<?php echo $order_voucher['voucher_theme_id']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][message]" value="<?php echo $order_voucher['message']; ?>" />
                  <input  class="form-control"type="hidden" name="order_voucher[<?php echo $voucher_row; ?>][amount]" value="<?php echo $order_voucher['amount']; ?>" /></td>
                <td class="left"></td>
                <td class="right">1</td>
                <td class="right"><?php echo $order_voucher['amount']; ?></td>
                <td class="right"><?php echo $order_voucher['amount']; ?></td>
          ...
          <table  cellpadding="10" width="100%" class="list">
            ...
            <tbody>
              <tr>
                ...
                <td class="left"><input  class="form-control"type="text" name="to_name" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $entry_to_email; ?></td>
                <td class="left"><input  class="form-control"type="text" name="to_email" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $entry_from_name; ?></td>
                <td class="left"><input  class="form-control"type="text" name="from_name" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $entry_from_email; ?></td>
                <td class="left"><input  class="form-control"type="text" name="from_email" value="" /></td>
              </tr>
              <tr>
                <td class="left"><span class="required">*</span> <?php echo $entry_theme; ?></td>
                <td class="left"><select class="form-control" name="voucher_theme_id">
              ...
              <tr>
                ...
                <td class="left"><input  class="form-control"type="text" name="amount" value="25.00" size="5" /></td>
              </tr>
            </tbody>
            <tfoot>
              <tr>
          ...
          <table cellpadding="10" width="100%" class="form">
            <tr>
              ...
              <td><select class="form-control" name="payment_address">
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
              <td><input  class="form-control"type="text" name="payment_firstname" value="<?php echo $payment_firstname; ?>" />
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
              <td><input  class="form-control"type="text" name="payment_lastname" value="<?php echo $payment_lastname; ?>" />
            ...
            <tr>
              ...
              <td><input  class="form-control"type="text" name="payment_company" value="<?php echo $payment_company; ?>" /></td>
            </tr>
            <tr id="company-id-display">
              <td><span id="company-id-required" class="required">*</span> <?php echo $entry_company_id; ?></td>
              <td><input  class="form-control"type="text" name="payment_company_id" value="<?php echo $payment_company_id; ?>" /></td>
            </tr>
            <tr id="tax-id-display">
              <td><span id="tax-id-required" class="required">*</span> <?php echo $entry_tax_id; ?></td>
              <td><input  class="form-control"type="text" name="payment_tax_id" value="<?php echo $payment_tax_id; ?>" />
            ...
            <tr>
              ...
              <td><input  class="form-control"type="text" name="payment_address_1" value="<?php echo $payment_address_1; ?>" />
            ...
            <tr>
              ...
              <td><input  class="form-control"type="text" name="payment_address_2" value="<?php echo $payment_address_2; ?>" /></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_city; ?></td>
              <td><input  class="form-control"type="text" name="payment_city" value="<?php echo $payment_city; ?>" />
            ...
            <tr>
              ...
              <td><input  class="form-control"type="text" name="payment_postcode" value="<?php echo $payment_postcode; ?>" />
            ...
            <tr>
              ...
              <td><select class="form-control" name="payment_country_id">
                  <option value=""><?php echo $text_select; ?></option>
            ...
            <tr>
              ...
              <td><select class="form-control" name="payment_zone_id">
                </select>
        ...
        <div id="tab-shipping" class="vtabs-content">
          <table cellpadding="10" width="100%" class="form">
            <tr>
              <td><?php echo $entry_address; ?></td>
              <td><select class="form-control" name="shipping_address">
                  <option value="0" selected="selected"><?php echo $text_none; ?></option>
                  <?php foreach ($addresses as $address) { ?>
                  <option value="<?php echo $address['address_id']; ?>"><?php echo $address['firstname'] . ' ' . $address['lastname'] . ', ' . $address['address_1'] . ', ' . $address['city'] . ', ' . $address['country']; ?></option>
                  <?php } ?>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_firstname; ?></td>
              <td><input  class="form-control"type="text" name="shipping_firstname" value="<?php echo $shipping_firstname; ?>" />
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_lastname; ?></td>
              <td><input  class="form-control"type="text" name="shipping_lastname" value="<?php echo $shipping_lastname; ?>" />
            ...
            <tr>
              <td><?php echo $entry_company; ?></td>
              <td><input  class="form-control"type="text" name="shipping_company" value="<?php echo $shipping_company; ?>" /></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_address_1; ?></td>
              <td><input  class="form-control"type="text" name="shipping_address_1" value="<?php echo $shipping_address_1; ?>" />
            ...
            <tr>
              <td><?php echo $entry_address_2; ?></td>
              <td><input  class="form-control"type="text" name="shipping_address_2" value="<?php echo $shipping_address_2; ?>" /></td>
            </tr>
            <tr>
              <td><span class="required">*</span> <?php echo $entry_city; ?></td>
              <td><input  class="form-control"type="text" name="shipping_city" value="<?php echo $shipping_city; ?>" /></td>
            </tr>
            <tr>
              <td><span id="shipping-postcode-required" class="required">*</span> <?php echo $entry_postcode; ?></td>
              <td><input  class="form-control"type="text" name="shipping_postcode" value="<?php echo $shipping_postcode; ?>" />
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_country; ?></td>
              <td><select class="form-control" name="shipping_country_id">
                  <option value=""><?php echo $text_select; ?></option>
                  <?php foreach ($countries as $country) { ?>
            ...
            <tr>
              <td><span class="required">*</span> <?php echo $entry_zone; ?></td>
              <td><select class="form-control" name="shipping_zone_id">
                </select>
		...
		if (ui.item['option'] != '') {
			...
			for (i = 0; i < ui.item['option'].length; i++) {
				...
				if (option['type'] == 'select') {
					...
					html += option['name'] + '<br />';
					html += '<select class="form-control" name="option[' + option['product_option_id'] + ']">';
					html += '<option value=""><?php echo $text_select; ?></option>';
				...
				if (option['type'] == 'checkbox') {
					...
					for (j = 0; j < option['option_value'].length; j++) {
						...
						html += '<input  class="form-control"type="checkbox" name="option[' + option['product_option_id'] + '][]" value="' + option_value['product_option_value_id'] + '" id="option-value-' + option_value['product_option_value_id'] + '" />';
				...
				if (option['type'] == 'text') {
					...
					html += option['name'] + '<br />';
					html += '<input  class="form-control"type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" />';
					html += '</div>';
					html += '<br />';
				}
				...
				if (option['type'] == 'file') {
					...
					html += '<input  class="form-control"type="hidden" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" />';
					html += '</div>';
					html += '<br />';
				}
				...
				if (option['type'] == 'date') {
					...
					html += option['name'] + '<br />';
					html += '<input  class="form-control"type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" class="date" />';
					html += '</div>';
					html += '<br />';
				}
				...
				if (option['type'] == 'datetime') {
					...
					html += option['name'] + '<br />';
					html += '<input  class="form-control"type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" class="datetime" />';
					html += '</div>';
					html += '<br />';						
				}
				...
				if (option['type'] == 'time') {
					...
					html += option['name'] + '<br />';
					html += '<input  class="form-control"type="text" name="option[' + option['product_option_id'] + ']" value="' + option['option_value'] + '" class="time" />';
					html += '</div>';
					html += '<br />';						
				}
			}
		...
		success: function(json) {
			...
			if (json['order_product'] != '') {
				...
				for (i = 0; i < json['order_product'].length; i++) {
					...
					html += '  <td class="left">' + product['name'] + '<br /><input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_product_id]" value="" /><input  class="form-control"type="hidden" name="order_product[' + product_row + '][product_id]" value="' + product['product_id'] + '" /><input  class="form-control"type="hidden" name="order_product[' + product_row + '][name]" value="' + product['name'] + '" />';
					...
					if (product['option']) {
						for (j = 0; j < product['option'].length; j++) {
							...
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][order_option_id]" value="' + option['order_option_id'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][product_option_id]" value="' + option['product_option_id'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][product_option_value_id]" value="' + option['product_option_value_id'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][name]" value="' + option['name'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][value]" value="' + option['value'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_option][' + option_row + '][type]" value="' + option['type'] + '" />';
					...
					if (product['download']) {
						for (j = 0; j < product['download'].length; j++) {
							...
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_download][' + download_row + '][order_download_id]" value="' + download['order_download_id'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_download][' + download_row + '][name]" value="' + download['name'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_download][' + download_row + '][filename]" value="' + download['filename'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_download][' + download_row + '][mask]" value="' + download['mask'] + '" />';
							html += '  <input  class="form-control"type="hidden" name="order_product[' + product_row + '][order_download][' + download_row + '][remaining]" value="' + download['remaining'] + '" />';
					...
					html += '  </td>';
					html += '  <td class="left">' + product['model'] + '<input  class="form-control"type="hidden" name="order_product[' + product_row + '][model]" value="' + product['model'] + '" /></td>';
					html += '  <td class="right">' + product['quantity'] + '<input  class="form-control"type="hidden" name="order_product[' + product_row + '][quantity]" value="' + product['quantity'] + '" /></td>';
					html += '  <td class="right">' + product['price'] + '<input  class="form-control"type="hidden" name="order_product[' + product_row + '][price]" value="' + product['price'] + '" /></td>';
					html += '  <td class="right">' + product['total'] + '<input  class="form-control"type="hidden" name="order_product[' + product_row + '][total]" value="' + product['total'] + '" /><input  class="form-control"type="hidden" name="order_product[' + product_row + '][tax]" value="' + product['tax'] + '" /><input  class="form-control"type="hidden" name="order_product[' + product_row + '][reward]" value="' + product['reward'] + '" /></td>';
					html += '</tr>';
			...
			if (json['order_voucher'] != '') {
				var voucher_row = 0;
				 ...
				 for (i in json['order_voucher']) {
					...
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][order_voucher_id]" value="" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][voucher_id]" value="' + voucher['voucher_id'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][description]" value="' + voucher['description'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][code]" value="' + voucher['code'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][from_name]" value="' + voucher['from_name'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][from_email]" value="' + voucher['from_email'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][to_name]" value="' + voucher['to_name'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][to_email]" value="' + voucher['to_email'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][voucher_theme_id]" value="' + voucher['voucher_theme_id'] + '" />';	
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][message]" value="' + voucher['message'] + '" />';
					html += '  <input  class="form-control"type="hidden" name="order_voucher[' + voucher_row + '][amount]" value="' + voucher['amount'] + '" />';
					html += '  </td>';
			...
			if (json['order_product'] != '' || json['order_voucher'] != '' || json['order_total'] != '') {
				...
				for (i in json['order_total']) {
					...
					html += '  <td class="right" colspan="4"><input  class="form-control"type="hidden" name="order_total[' + total_row + '][order_total_id]" value="" /><input  class="form-control"type="hidden" name="order_total[' + total_row + '][code]" value="' + total['code'] + '" /><input  class="form-control"type="hidden" name="order_total[' + total_row + '][title]" value="' + total['title'] + '" /><input  class="form-control"type="hidden" name="order_total[' + total_row + '][text]" value="' + total['text'] + '" /><input  class="form-control"type="hidden" name="order_total[' + total_row + '][value]" value="' + total['value'] + '" /><input  class="form-control"type="hidden" name="order_total[' + total_row + '][sort_order]" value="' + total['sort_order'] + '" />' + total['title'] + ':</td>';
