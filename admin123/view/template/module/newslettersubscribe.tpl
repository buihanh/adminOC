...
<tr>
        ...
        <tfoot>
         <?php  
		 /*
		 for($l=1;$l<=$newslettersubscribe_option_field;$l++){ 
          ...
          <tr> 
            ...
            <td class="left"><select name="newslettersubscribe_module[<?php echo $module_row; ?>][position]">
				...
				<?php if ($module['position'] == 'showcase') { ?>
                  <option value="showcase" selected="selected">Showcase</option>
                  <?php }else{ ?>
				  ...
				  <?php if ($module['position'] == 'mass_bottom') { ?>
                  <option value="mass_bottom" selected="selected">mass</option>
                  <?php } else{ ?>
				  <option value="mass_bottom" >mass</option>
				  <?php }  ?>
            ...
            <td class="left"><select name="newslettersubscribe_module[<?php echo $module_row; ?>][show]">
                <?php if ($module['show']) { ?>
...
function addModule() {	
	...
	html += '<option value="showcase" >Showcase</option>';
	html += '<option value="promotion" >Promotion</option>';
	html += '<option value="mass_bottom" >mass</option>';
	...
	html += '    </select></td>';
	html += '    <td class="left"><select name="newslettersubscribe_module[' + module_row + '][show]">';
    html += '      <option value="1" selected="selected">Full</option>';
    html += '      <option value="0">Column</option>';
    html += '    </select></td>';
