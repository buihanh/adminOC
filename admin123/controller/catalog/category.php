...
class ControllerCatalogCategory extends Controller { 
    ...
    public function  fcdelete(){
        ...
        $temp = $this->model_catalog_category->deleteCategory($category_id);
        echo "OK";
        die();
    }
	...
	protected function getForm() {
        ...
        $this->data['categories'] = array();
        $this->load->model('catalog/category');
     //   $category_parent =  $this->model_catalog_category->getCategories_parent();
        $this->data['category_sub'] =  $this->model_catalog_category->getCategories_sub();
