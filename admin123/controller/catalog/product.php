...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$this->data['text_yes'] = 'Có';
		$this->data['text_no'] = 'Không';
		...
		if (isset($this->request->post['filesoure'])) {
			$this->data['filesoure'] = $this->request->post['filesoure'];
		} elseif (!empty($product_info)) {
			$this->data['filesoure'] = $product_info['filesoure'];
		} else {
			$this->data['filesoure'] = '';
		}
		if (isset($this->request->post['viewdemo'])) {
			$this->data['viewdemo'] = $this->request->post['viewdemo'];
		} elseif (!empty($product_info)) {
			$this->data['viewdemo'] = $product_info['viewdemo'];
		} else {
			$this->data['viewdemo'] = '';
		}
