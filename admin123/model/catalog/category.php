...
class ModelCatalogCategory extends Model {
    ...
    public function getCategories_parent($parent_id = 0) {
        $query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category c LEFT JOIN " . DB_PREFIX . "category_description cd ON (c.category_id = cd.category_id) LEFT JOIN " . DB_PREFIX . "category_to_store c2s ON (c.category_id = c2s.category_id) WHERE c.parent_id = '" . (int)$parent_id . "' AND cd.language_id = '" . (int)$this->config->get('config_language_id') . "' AND c2s.store_id = '" . (int)$this->user->getStoreID() . "'  AND c.status = '1' ORDER BY c.sort_order, LCASE(cd.name)");

        return $query->rows;
    }
    public function getCategories_sub() {
    ...
    public function addCategory($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "category_to_store SET category_id = '" . (int)$category_id . "', store_id = '" . (int)$this->user->getStoreID(). "'");
	...
	public function editCategory($category_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "category_to_store WHERE category_id = '" . (int)$category_id . "' and store_id = ".$this->user->getStoreID()."  ");
	...
	public function getCategoryStores($category_id) {
		...
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "category_to_store WHERE category_id = '" . (int)$category_id . "'  and store_id = ".$this->user->getStoreID()." ");
	...
	public function getTotalCategories() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM " . DB_PREFIX . "category c join " . DB_PREFIX . "category_to_store cs on cs.category_id = c.category_id  WHERE cs.store_id = ".$this->user->getStoreID()." ");
